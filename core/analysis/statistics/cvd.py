#core/analysis/statistics/cvd.py
"""Calculador de Cumulative Volume Delta (CVD)."""
...
class CvdCalculator:
    ...
    __slots__ = ['cvd_history', 'cumulative_cvd', 'cumulative_cvd_total']
    ...
    def update_and_get_roc(self, recent_trades: List[Trade], roc_period: int = 10) -> float:
    ...
    def update_cumulative(self, trade: Trade) -> None:
