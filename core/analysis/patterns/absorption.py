#core/analysis/patterns/absorption.py
"""Detector de padrões de absorção e escoras de volume."""
...
class AbsorptionDetector:
    ...
    def __init__(self, concentration_threshold: float = 0.4, min_volume_threshold: int = 200):
