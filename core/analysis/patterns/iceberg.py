#core/analysis/patterns/iceberg.py
"""Detector de ordens do tipo Iceberg (travamento de preço)."""
...
class IcebergDetector:
    ...
    __slots__ = ['repetitions', 'min_volume']

    def __init__(self, repetitions: int = 3, min_volume: int = 50):
